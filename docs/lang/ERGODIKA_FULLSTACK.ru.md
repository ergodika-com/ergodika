# Ergodika для Senior Full-Stack разработчиков
...
> Публичный архитектурный brief. Объясняет **как спроектирован и реализован Ergodika**, чтобы senior-разработчик мог понять систему до чтения всего приватного репозитория.

## Для кого

**Senior full-stack** инженеры: архитектура, инварианты, границы модулей — не установочный туториал.
